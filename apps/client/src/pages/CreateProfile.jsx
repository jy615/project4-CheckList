...
import { api, instance } from "../constant";
...
function CreateProfile({ isAuth }) {
  ...
  const getProfile = async () => {
    ...
    fetch(`${api}/auth/get/user/${id}`, { headers: headers })
      .then((res) => {
  ...
  //   if (_csrfToken === null) {
  //     await fetch(`${api}/auth/createProflie`, {
  //       method: "POST",
  //       headers: {
  ...
  const handleSubmit = async (e) => {
    try {
      e.preventDefault();
      const re=await instance.post("/auth/createProflie", {
        id:id,
        name:name,
        dob:date,
        speciality:special,
          ...
          >
            ...
            <div className="p-4 flex">
              ...
              <input
                ...
                onChange={(e) => setSpecial(e.target.value)}
              />
                <label for="css">Medical Technologist</label>
              <br /> {" "}
              <input
                type="radio"
                id="nurse"
